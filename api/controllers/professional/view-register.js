...
module.exports = {
  ...
  fn: async function (inputs) {
    ...
    switch (this.req.method) {
      case 'GET':
        return this.res.view('pages/professional/register', {layout: 'layouts/login', error_message: '', countries, rates, professions, countryOrigin: countryOrigin});
        break;
      case 'POST':
        ...
        try {
          ...
          if(e.raw && e.raw.serverError && e.raw.serverError.code === 'E_INVALID_ARGINS'){
            if(e.raw.serverError.problems && e.raw.serverError.problems.length>0) {
              ...
              return this.res.view('pages/professional/register', {layout: 'layouts/login', error_message: error_message, countries, rates, professions, countryOrigin: countryOrigin});
            }
          }
          return this.res.view('pages/professional/register', {layout: 'layouts/login', error_message: e.code, countries, rates, professions, countryOrigin: countryOrigin});
